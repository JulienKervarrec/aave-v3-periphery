# 1. Architecture — Aave V3 Periphery

Ce dépôt rassemble les composants de référence consacrés à les contrats périphériques, les passerelles et les interfaces de données autour d’Aave V3.
...
[Chapitre suivant : Passerelles de dépôt et retrait](02-passerelles-de-depot-et-retrait.md)
