# 2. Passerelles de dépôt et retrait

Le premier mécanisme central du dépôt concerne passerelles de dépôt et retrait.
...
[Chapitre suivant : Fournisseurs de données et adresses](03-fournisseurs-de-donnees-et-adresses.md)
